...
switch (opsi){
	...
	case 2 :
		...
		cout<<"Bayar : "; cin>>bayar;
		cout<<"Total Kembalian : "<<bayar-pertamina.pertalite(liter);
		cout<<"\n\n######################### Terimakasih #########################";
	break;
	...
	case 3 :
		...
		cout<<"Bayar : "; cin>>bayar;
		cout<<"Total Kembalian : "<<bayar-pertamina.pertamax(liter);
		cout<<"\n\n######################### Terimakasih #########################";
	break;
	...
	case 4 :
		...
		cout<<"Bayar : "; cin>>bayar;
		cout<<"Total Kembalian : "<<bayar-pertamina.solar(liter);
		cout<<"\n\n######################### Terimakasih #########################";
	break;
}
return 0;
